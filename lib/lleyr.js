var program = require('commander')
	...
	exports.launch = function(){ 
		...
		var command = opts._[0] ;   // get an array of the unmatched, positional args
		var allowed = ['build', 'production', 'serve', 'edit', 'nolr', 'onlyassets', 'init'];
			...
			// Run/Execute
			if(opts._.length && _.indexOf(allowed,command) > -1){
				run(command);
			}else{
				_cl('Couldn\'t identify :' + command, 'red');
			}
	}
